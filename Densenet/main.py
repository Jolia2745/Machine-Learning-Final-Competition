...
class Args:
    def __init__(self):
        ...
        self.lr = 1e-2     # 0.01  # 
        self.momentum = 0.9
        self.weight_decay = 1e-6 # 1e-2       
        self.print_freq = 10
        self.evaluate = False
        self.pretrained = False 
        self.half = False
        self.save_dir = './densenet_model'
        self.save_every = 10
...
def main():
    ...
    model = DenseNet(reduction=0.5, classes=4)
    ...
    best_model_path = './densenet_model/model_best.th'
