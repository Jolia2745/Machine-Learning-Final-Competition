...
def audio_to_image(file_path, save_path):
    ...
    print(mfccs.shape, mfccs_processed.shape, chroma.shape,  chroma_processed.shape, spec_contrast.shape,spec_centroid_processed.shape)
    #(40, 259) (40,) (12, 259) (12,) (7, 259) (1,)
    # output: # (XX, 259)
